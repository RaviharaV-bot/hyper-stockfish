...
RUN polyglot make-book -hyper-standard.pgn -hyper-standard-white.bin -1000000000000 -1 -1 -only-white
RUN polyglot make-book -hyper-standard.pgn -hyper-standard-black.bin -1000000000000 -1 -1 -only-black
